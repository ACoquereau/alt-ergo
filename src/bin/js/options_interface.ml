...
let set_options r =
  ...
  set_options_opt Options.set_answers_with_locs r.answers_with_loc;
  set_options_opt Options.set_input_format
    (get_input_format r.input_format);
  set_options_opt Options.set_infer_input_format r.infer_input_format;
  ...
  set_options_opt Options.set_infer_output_format r.infer_output_format;
  set_options_opt Options.set_unsat_core r.unsat_core;

  set_options_opt Options.set_verbose r.verbose;

  set_options_opt Options.set_greedy r.greedy;
