...
html: doc
	xdg-open $(DEFAULT_BUILD_DIR)/_doc/_html/index.html
...
js-example: gen js-worker
	$(DUNE) build $(DUNE_FLAGS) --profile=release $(BJS_DIR)/main_js.bc.js
	mkdir -p www
	cp $(BJS_DIR)/index.html www/
	cd www \
	&& ln -sf ../$(DEFAULT_BUILD_DIR)/$(BJS_DIR)/worker_js.bc.js alt-ergo-worker.js \
	&& ln -sf ../$(DEFAULT_BUILD_DIR)/$(BJS_DIR)/main_js.bc.js alt-ergo-main.js \
